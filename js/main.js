...
function sunHours() {
    ...
    theZone += 1; //because zones starts from 1
    switch (theZone) {
        case 1:
            hrs = 6;
            break;
...
function calculateSolar() {
    ...
    var feedback = "";
    feedback += "<p>Based on your average daily use of " + Math.round(dailyUseKw) + " kWh, you will need to purchase " + panelNeeded + " " + panelName + " solar " +
    ...
    feedback += "<p>Realistic watts need per hour: " + Math.round(realWattNeeds) + " watts/hour.</p>";
